...
if (Lang == "en") {
    ...
    var oneletterdays = ["Su","M","Tu","W","Th","F","Sa"];
...
if (Lang == "cz") {
    ...
    var oneletterdays = ["N", "Po", "Ú", "S", "Č", "Pá", "S"];
...
if (Lang == "it") {
    ...
    var oneletterdays = ["Su", "Mo", "Ma", "Me", "G", "V", "Sa"];
...
if (Lang == "ca") {
    ...
    var shortdays = ["Sol", "Mon", "Mar", "Mie", "Jue", "Vie", "Sat"];
    var oneletterdays = ["So", "Mo", "Ma", "Mi", "J", "V", "Sa"];
...
if (Lang == "de") {
    ...
    var oneletterdays = ["So", "Mo", "Di", "Mi", "D", "F", "Sa"];
...
if (Lang == "fr") {
    ...
    var weatherdesc = ["Tornade", "Tropical", "Ouragan", "Orages Violents", "Orages", "Pluie", "Pluie", "Neige", "Bruine", "Bruine", "Pluie", "Averses", "Averses", "Quelques Flocons", "Faibles Chutes de Neige", "Rafales de Neige", "Neige", "Grele", "Neige Fondue", "Poussiereux", "Brouillard", "Brume", "Brumeux", "Tempete", "Vent", "Temps Froid", "Temps Nuageux ", "Tres Nuageux", "Tres Nuageux", "Nuageux", "Nuageux", "Temps Clair", "Ensoleille", "Beau Temps", "Beau Temps", "Pluie et Greles", "Temps Chaud", "Orages Isoles", "Orages Eparses", "Orages Eparses", "Averses Eparses", "Fortes Chutes de Neige", "Chutes de Neige Eparses", "Fortes Chutes de Neige", "Nuageux", "Orages", "Chute de Neige", "Orages Isoles", "Non Disponible"];
}
if (Lang == "ru") {
    var days =  ["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"];
    var shortdays = ["Вос", "Пон", "Вто", "Сре", "Чет", "Пят", "Суб"];
    var oneletterdays = ["Во", "По", "Вт", "Ср", "Ч", "Пя", "Су"];
...
if (Lang == "pl") {
    ...
    var oneletterdays = ["N", "Po", "W", "Sr", "C", "Pi", "So"];
...
if (Lang == "pt") {
    ...
    var oneletterdays = ["D", "S", "T", "Q", "Q.", "S.", "Sa"];
...
if (Lang == "no") {
    ...
    var oneletterdays = ["S", "M", "Ti", "O", "To", "F", "L"];
...
if (Lang == "nl") {
    ...
    var oneletterdays = ["Zo", "M", "Di", "W", "Do", "V", "Za"];
...
if (Lang == "fi") {
    ...
    var oneletterdays = ["S", "M", "Ti", "K", "To", "P", "L"];
...
if (Lang == "cn") {
    ...
    var oneletterdays = ["日","一","二","三","四","五","六"];
